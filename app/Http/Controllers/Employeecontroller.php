...
class EmployeeController extends Controller
{
        ...
        try {
            ...
            if (!$guestEmployee) {
                return response()->json([
                    'success' => false,
                    'message' => 'Anda tidak memiliki akses ke tamu ini',
                ], 403);
            }
            ...
            if ($guest->status !== 'verified') {
                return response()->json([
                    'success' => false,
                    'message' => 'Status tamu tidak valid untuk memulai pertemuan',
                ], 400);
            }

            // Update status ke meeting
            DB::table('guests')
                ->where('id', $id)
                ->update([
                    'status' => 'meeting',
            ...
            return response()->json([
                'success' => true,
                'message' => 'Pertemuan dimulai. Status tamu diperbarui.',
            ]);
    ...
    public function checkout($id)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Tamu berhasil checkout. Terima kasih!',
            ]);
