                ...
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role" class="form-select @error('role') is-invalid @enderror" id="role-select" required>
                            ...
                            <option value="receptionist" {{ old('role', $user->role) == 'receptionist' ? 'selected' : '' }}>PTSP</option>
                    ...
                    <div id="employee-fields" style="display: {{ old('role', $user->role) == 'employee' ? 'block' : 'none' }};">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" 
                                value="{{ old('keterangan', $user->keterangan) }}" placeholder="Contoh: Ketua Majelis, Wakil Ketua, dll">
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
