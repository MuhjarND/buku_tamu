    ...
    <div class="col-lg-4 mb-4">
        ...
        <div class="card stat-card">
            <div class="card-body text-center">
                ...
                <a href="{{ route('admin.guests.index') }}" class="btn btn-secondary mt-2 w-100">
...
function verifyGuest(guestId) {
    ...
    $.ajax({
        url: `/admin/guest/${guestId}/verify`,
        method: 'POST',
        beforeSend: function() {
        ...
        success: function(response) {
            ...
            window.location.href = '{{ route("admin.guests.index") }}';
        },
        error: function(xhr) {
...
function confirmReject() {
    ...
    $.ajax({
        url: `/admin/guest/${currentGuestId}/reject`,
        method: 'POST',
        data: { reason: reason },
        beforeSend: function() {
            $('button').prop('disabled', true);
